...
F 0 "J6" H 10380 1192 50  0000 L CNN
F 1 "Banana Jack" H 10380 1101 50  0000 L CNN
F 2 "Connector:Banana_Jack_2Pin_Standard_Spacing" H 10300 1200 50  0001 C CNN
F 3 "~" H 10300 1200 50  0001 C CNN
F 4 "The hole has a diameter of about 5.2mm (fits standard 4mm banana plugs), the cap on the front has an outside diameter of about 11.6mm and length of 15.2mm. Diameter of the screw is 3.8mm. The mounting key is about 4 x 5.4mm." H -150 -1100 50  0001 C CNN "Description"
	1    10300 1200
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "#PWR0104" H 9950 1100 50  0001 C CNN
F 1 "VDC" H 9950 1475 50  0000 C CNN
...
U 1 1 5D9F3CF1
P 9950 1350
F 0 "#PWR0162" H 9950 1100 50  0001 C CNN
...
F 1 "Banana Jack" H 10380 1801 50  0000 L CNN
F 2 "Connector:Banana_Jack_2Pin_Standard_Spacing" H 10300 1900 50  0001 C CNN
F 3 "~" H 10300 1900 50  0001 C CNN
F 4 "The hole has a diameter of about 5.2mm (fits standard 4mm banana plugs), the cap on the front has an outside diameter of about 11.6mm and length of 15.2mm. Diameter of the screw is 3.8mm. The mounting key is about 4 x 5.4mm." H -150 -400 50  0001 C CNN "Description"
	1    10300 1900
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5D9F3D60
P 9950 2050
F 0 "#PWR0163" H 9950 1800 50  0001 C CNN
...
U 1 1 5D9F3DC6
P 9950 1900
F 0 "#PWR0164" H 9950 1750 50  0001 C CNN
F 1 "VAA" H 9967 2073 50  0000 C CNN
...
F 0 "J8" H 10380 2642 50  0000 L CNN
F 1 "Banana Jack" H 10380 2551 50  0000 L CNN
F 2 "Connector:Banana_Jack_2Pin_Standard_Spacing" H 10300 2650 50  0001 C CNN
F 3 "~" H 10300 2650 50  0001 C CNN
F 4 "The hole has a diameter of about 5.2mm (fits standard 4mm banana plugs), the cap on the front has an outside diameter of about 11.6mm and length of 15.2mm. Diameter of the screw is 3.8mm. The mounting key is about 4 x 5.4mm." H -150 350 50  0001 C CNN "Description"
	1    10300 2650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5D9F3E32
P 9950 2800
F 0 "#PWR0165" H 9950 2550 50  0001 C CNN
...
F 0 "J9" H 10380 3342 50  0000 L CNN
F 1 "Banana Jack" H 10380 3251 50  0000 L CNN
F 2 "Connector:Banana_Jack_2Pin_Standard_Spacing" H 10300 3350 50  0001 C CNN
F 3 "~" H 10300 3350 50  0001 C CNN
F 4 "The hole has a diameter of about 5.2mm (fits standard 4mm banana plugs), the cap on the front has an outside diameter of about 11.6mm and length of 15.2mm. Diameter of the screw is 3.8mm. The mounting key is about 4 x 5.4mm." H -150 1050 50  0001 C CNN "Description"
	1    10300 3350
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5D9F4043
P 9950 3500
F 0 "#PWR0166" H 9950 3250 50  0001 C CNN
...
U 1 1 5D9F41BC
P 10000 3300
F 0 "#PWR0167" H 10000 3150 50  0001 C CNN
F 1 "VD" H 10017 3473 50  0000 C CNN
...
F 0 "H5" H 9200 3846 50  0000 L CNN
F 1 "MountingHole" H 9200 3755 50  0000 L CNN
F 2 "MountingHole:MountingHole_2.5mm" H 9100 3800 50  0001 C CNN
...
F 0 "H6" H 9200 4246 50  0000 L CNN
F 1 "MountingHole" H 9200 4155 50  0000 L CNN
F 2 "MountingHole:MountingHole_2.5mm" H 9100 4200 50  0001 C CNN
...
F 0 "H7" H 8400 3846 50  0000 L CNN
F 1 "MountingHole" H 8400 3755 50  0000 L CNN
F 2 "MountingHole:MountingHole_2.5mm" H 8300 3800 50  0001 C CNN
...
F 0 "H8" H 8400 4246 50  0000 L CNN
F 1 "MountingHole" H 8400 4155 50  0000 L CNN
F 2 "MountingHole:MountingHole_2.5mm" H 8300 4200 50  0001 C CNN
...
U 1 1 5CA605F6
P 5650 2200
AR Path="/5D94288A/5CA605F6" Ref="#PWR?"  Part="1" 
AR Path="/5D968A33/5CA605F6" Ref="#PWR?"  Part="1" 
AR Path="/5C90F517/5CA605F6" Ref="#PWR?"  Part="1" 
...
U 1 1 5CA605F9
P 5600 3200
AR Path="/5D94288A/5CA605F9" Ref="#PWR?"  Part="1" 
AR Path="/5D968A33/5CA605F9" Ref="#PWR?"  Part="1" 
AR Path="/5C90F517/5CA605F9" Ref="#PWR?"  Part="1" 
F 0 "#PWR?" H 5600 3320 50  0001 C CNN
...
U 1 1 5CA605FC
P 5700 2600
AR Path="/5D94288A/5CA605FC" Ref="#PWR?"  Part="1" 
AR Path="/5D968A33/5CA605FC" Ref="#PWR?"  Part="1" 
AR Path="/5C90F517/5CA605FC" Ref="#PWR?"  Part="1" 
...
AR Path="/5C90F517/5CAA0185" Ref="#PWR?"  Part="1" 
...
U 1 1 5CA605E3
P 5400 3050
AR Path="/5D94288A/5CA605E3" Ref="#PWR?"  Part="1" 
AR Path="/5D968A33/5CA605E3" Ref="#PWR?"  Part="1" 
AR Path="/5C90F517/5CA605E3" Ref="#PWR?"  Part="1" 
...
U 1 1 5CA605E6
P 2450 3650
AR Path="/5D94288A/5CA605E6" Ref="#PWR?"  Part="1" 
AR Path="/5D968A33/5CA605E6" Ref="#PWR?"  Part="1" 
AR Path="/5C90F517/5CA605E6" Ref="#PWR?"  Part="1" 
...
U 1 1 5CA605ED
P 2550 2950
AR Path="/5D94288A/5CA605ED" Ref="#PWR?"  Part="1" 
AR Path="/5D968A33/5CA605ED" Ref="#PWR?"  Part="1" 
AR Path="/5C90F517/5CA605ED" Ref="#PWR?"  Part="1" 
...
AR Path="/5C90F517/5CB70C86" Ref="#PWR?"  Part="1" 
...
AR Path="/5C90F517/5CB7B866" Ref="#PWR?"  Part="1" 
